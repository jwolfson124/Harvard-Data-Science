...
# 40% testing set 
x_train, x_test, y_train, y_test = train_test_split(x,y,train_size=.6,random_state=66)
### edTest(test_nums) ###
...
##The image here will show the different k values of 1,10,70 and how they go through the actual data set
...
##The image here will show the MSE values based on the value of KNN and this information will be used to identify the best KNN value for the model

# Find the lowest MSE among all the kNN models
min_mse = min(knn_dict)
